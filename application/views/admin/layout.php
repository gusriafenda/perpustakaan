...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo base_url();?>admin/Home" class="logo">
      ...
      <span class="logo-lg"><b>PERPUS</b> SMKN 1</span>
    </a>
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              foreach ($log as $key => $value) {
                ?>
              <img src="http://localhost/db_perpustakaan/gambar_petugas/mahniar.jpg" class="user-image" alt="User Image">
            ...
            <ul class="dropdown-menu">
              ...
              foreach ($log as $key => $value) {
                ?>
                <img src="http://localhost/db_perpustakaan/gambar_petugas/mahniar.jpg" class="img-circle" alt="User Image">

                <p>
                  <?php echo $value->nama;?>
                  <small>Admin Perpustakaan smkn 1 gandapura</small>
                </p>
                <?php
              }
              ?>
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="<?php echo base_url(); ?>web/logout" class="btn btn-danger btn-flat">logout</a>
                </div>
              </li>
            </ul>
          </li>
    ...
    <section class="sidebar">
      ...
      <center>
        <a href="<?php echo base_url();?>admin/Home">
          <img src="<?php echo base_url(); ?>assets2/img/SMK 1.jpg" alt="" srcset="" width="46px">
        </a>
      </center>
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong><a href="">SMKN 1 GANDAPURA</a>.</strong> 
  </footer>
