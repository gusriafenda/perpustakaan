...
<head>
    ...
    <style>
    .bgg {
        background-image: url('<?php echo base_url(); ?>assets2/img/logo.png');
            ...
            <nav class="teal darken-2">
                <div class="container">
                        ...
                        <div class="nav-wrapper">
                            <a href="<?php echo base_url();?>Buku" class="brand-logo"><img src="<?php echo base_url(); ?>assets2/img/SMK 1.jpg" width="45px" alt=""></a>
    ...
    <div class="section no-pad-bot">
      <div class="container">
        ...
        <div class="row center">
          <img class=" responsive-img z-depth-5" width="100px" src="<?php echo base_url(); ?>assets2/img/SMK 1.jpg" alt="" srcset="">
        </div>
        <h3 class="header center white-text text-lighten-2 z-depth-5">SISTEM INFORMASI PERPUSTAKAAN SMAKN 1 GANDAPURA</h3>
       

      </div>
    </div>
    <div class="parallax"><img src="<?php echo base_url(); ?>assets2/img/buku.jpg" alt="Unsplashed background img 1"></div>
  </div>
  <!-- Slider end -->
    ...
    <div class="content-wrapper">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    Email &copy; : <a href="" target="_blank">smkn1gandapurabireun09@gmail.com</a>
                </div>
